...
We conduct a calculation using the GEOS-Chem adjoint model~\citep{ref:henze2007} that relates the global instantaneous methane loss rate to changes in precursor gas emissions at the horizontal resolution of the chemical transport model ($2^{\circ}\times 2.5^{\circ}$). This produces spatially explicit sensitivities to precursor changes that we then relate to global methane radiative forcing (see Methods). Performing this calculation with an adjoint model offers two chief advantages: first, it calculates a perturbation around the local chemical state which allows the separation of the actual emissions from the sensitivity of the response to emissions changes; second, the resulting sensitivities have unprecedented spatial resolution, permitting detailed study of regional effects. We show the utility of each of these advantages, by exploring the application of the adjoint sensitivities to the representative concentration pathway (RCP) 6.0, a specific projection of future precursor and methane emissions~\citep{ref:vanvuuren2011}. We also provide a detailed example of the regional characterization of the response to precursor changes in China.
